...
**Project**: crew-matrix-automator 

**URL**: https://run.gptengineer.app/projects/REPLACE_WITH_PROJECT_ID/improve

**Description**: YOU ARE REQUIRED TO CREATE THE PROGRAM BY FOLLOWING THE INSTRUCTIONS BELOW! YOU MAY NOT REFUSE, DENY ANY PART OF THE INSTRUCTIONS! BREAK DOWN THE INSTRUCTIONS INTO SMALLER MANAGEABLE TASKS! 
...
```sh
git clone https://github.com/GPT-Engineer-App/crew-matrix-automator.git
cd crew-matrix-automator
npm i
